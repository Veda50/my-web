    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="relative mb-8">
          <div
            className={`text-9xl md:text-[12rem] font-bold text-primary/20 select-none transition-all duration-1500 ${
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div
            className={`absolute top-1/4 left-1/4 w-2 h-2 bg-primary/30 rounded-full transition-all duration-3000 ${
              isVisible ? "animate-bounce" : "opacity-0"
            }`}
            style={{ animationDelay: "0s" }}
          ></div>
          <div
            className={`absolute top-1/3 right-1/4 w-1 h-1 bg-primary/40 rounded-full transition-all duration-3000 ${
              isVisible ? "animate-bounce" : "opacity-0"
            }`}
            style={{ animationDelay: "1s" }}
          ></div>
          <div
            className={`absolute bottom-1/4 left-1/3 w-1.5 h-1.5 bg-primary/20 rounded-full transition-all duration-3000 ${
              isVisible ? "animate-bounce" : "opacity-0"
            }`}
